    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 class="mt-1 text-2xl font-semibold text-slate-950 dark:text-white">{{ $t('admin.mod.cheaters.title') }}</h1>
        </div>

        <div class="flex flex-wrap items-center gap-2">
          <UButton color="neutral" variant="outline" icon="i-lucide-flag" :to="localePath('/admin/mod/reports')">
            {{ $t('admin.mod.reports.title') }}
          </UButton>
          <UButton color="primary" variant="soft" icon="i-lucide-radar" :to="localePath('/admin/mod/cheaters')">
