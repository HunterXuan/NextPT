...
type ForumCategoryCreateReq struct {
	g.Meta `path:"/forum/categories" method:"post" tags:"AdminForum" summary:"创建论坛节点分类" perm:"admin:forum/category:*"`
...
type ForumCategoryUpdateReq struct {
	g.Meta `path:"/forum/categories/{id}" method:"patch" tags:"AdminForum" summary:"更新论坛节点分类" perm:"admin:forum/category:*"`
...
type ForumCategoryDeleteReq struct {
	g.Meta `path:"/forum/categories/{id}" method:"delete" tags:"AdminForum" summary:"删除论坛节点分类" perm:"admin:forum/category:*"`
...
type ForumCategoryListReq struct {
	g.Meta `path:"/forum/categories" method:"get" tags:"AdminForum" summary:"获取论坛节点分类列表" perm:"admin:forum/category:*"`
