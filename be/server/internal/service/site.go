...
type (
	...
	ISiteConfigDomain interface {
		GetConfigByGroupAndKey(ctx context.Context, group string, key string) (*entity.SiteConfig, error)
		...
		AdminListConfigs(ctx context.Context, group string) ([]*entity.SiteConfig, error)
		AdminUpdateConfig(ctx context.Context, group string, key string, value string) error
	}
)
