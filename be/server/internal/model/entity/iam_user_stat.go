...
type IamUserStat struct {
	...
	Uploaded      uint64      `json:"uploaded"      orm:"uploaded"       description:"总入账上传量 (bytes)"`
	Downloaded    uint64      `json:"downloaded"    orm:"downloaded"     description:"总入账下载量 (bytes)"`
	RawUploaded   uint64      `json:"rawUploaded"   orm:"raw_uploaded"   description:"真实总上传量 (bytes)"`
	RawDownloaded uint64      `json:"rawDownloaded" orm:"raw_downloaded" description:"真实总下载量 (bytes)"`
