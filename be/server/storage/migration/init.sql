...
CREATE TABLE `forum_category` (
    ...
    `sort_order`      SMALLINT        NOT NULL DEFAULT 0,
    `min_role_view`   SMALLINT        NOT NULL DEFAULT 0  COMMENT '最低可见等级',
    `created_at`      DATETIME        NULL,
    `updated_at`      DATETIME        NULL,
    PRIMARY KEY (`id`)
...
CREATE TABLE `forum_node` (
    ...
    `desc_i18n`       JSON            NULL COMMENT '多语言描述映射',
    `sort_order`      SMALLINT        NOT NULL DEFAULT 0,
    `min_role_read`   SMALLINT        NOT NULL DEFAULT 0,
    `min_role_write`  SMALLINT        NOT NULL DEFAULT 0,
    `min_role_create` SMALLINT        NOT NULL DEFAULT 0,
