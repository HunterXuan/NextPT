...
VALUES
    (
        1,
        '{"zh-CN":"站务","zh-TW":"站務","en-US":"Site Staff"}',
        '{"zh-CN":"公告、站点指南与内容处理","zh-TW":"公告、站點指南與內容處理","en-US":"Announcements, guides, and content handling"}',
        10,
        0,
        NOW(),
        NOW()
    ...
    (
        2,
        '{"zh-CN":"社区","zh-TW":"社群","en-US":"Community"}',
        '{"zh-CN":"交流、互助与邀请讨论","zh-TW":"交流、互助與邀請討論","en-US":"Discussion, help, and invitation exchange"}',
        20,
        0,
        NOW(),
        NOW()
...
VALUES
    (
        ...
        '{"zh-CN":"站点公告、活动与重要通知","zh-TW":"站點公告、活動與重要通知","en-US":"Site announcements, events, and important notices"}',
        10,
        0,
        130,
        130,
    ...
    (
        ...
        2,
        'general',
        '{"zh-CN":"闲谈","zh-TW":"閒談","en-US":"Lounge"}',
        '{"zh-CN":"日常交流与站内话题","zh-TW":"日常交流與站內話題","en-US":"Everyday conversation and site topics"}',
        20,
        0,
        0,
        0,
    ...
    (
        ...
        1,
        'site-guide',
        '{"zh-CN":"站点指南","zh-TW":"站點指南","en-US":"Site Guide"}',
        '{"zh-CN":"站规、新手引导与常见问题","zh-TW":"站規、新手引導與常見問題","en-US":"Rules, getting started, and frequently asked questions"}',
        20,
        0,
        130,
        130,
    ...
    (
        ...
        1,
        'trash',
        '{"zh-CN":"回收站","zh-TW":"回收站","en-US":"Trash"}',
        '{"zh-CN":"已删除或下架主题的管理员处理区","zh-TW":"已刪除或下架主題的管理員處理區","en-US":"Administrator workspace for deleted or delisted topics"}',
        90,
        150,
        150,
        150,
    ...
    (
        ...
        2,
        'technology',
        '{"zh-CN":"技术","zh-TW":"技術","en-US":"Tech"}',
        '{"zh-CN":"PT 客户端、做种、硬件与播放问题","zh-TW":"PT 用戶端、做種、硬體與播放問題","en-US":"PT clients, seeding, hardware, and playback"}',
        20,
        0,
        0,
        0,
    ...
    (
        ...
        2,
        'interests',
        '{"zh-CN":"兴趣","zh-TW":"興趣","en-US":"Interests"}',
        '{"zh-CN":"影视、动漫、音乐、体育与生活话题","zh-TW":"影視、動漫、音樂、體育與生活話題","en-US":"Film, anime, music, sports, and life"}',
        30,
        0,
        0,
        0,
    ...
    (
        ...
        2,
        'invitation-exchange',
        '{"zh-CN":"邀请交流","zh-TW":"邀請交流","en-US":"Invites"}',
        '{"zh-CN":"个人邀请、邀请申请与外站官方邀约","zh-TW":"個人邀請、邀請申請與外站官方邀約","en-US":"Personal invites, invitation requests, and official partner invitations"}',
        40,
        0,
        10,
        10,
    ...
    (
        ...
        2,
        'help-feedback',
        '{"zh-CN":"求助建议","zh-TW":"求助建議","en-US":"Help"}',
        '{"zh-CN":"使用求助、功能建议与规则反馈","zh-TW":"使用求助、功能建議與規則反饋","en-US":"Usage help, feature suggestions, and rule feedback"}',
        50,
        0,
        0,
        0,
